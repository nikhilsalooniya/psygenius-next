...
export function Header() {
  return (
    <header>
      <nav>
        <Container className="relative z-50 flex justify-between py-4 sm:py-8">
          <div className="relative z-10 flex items-center gap-4 sm:gap-16">
                    ...
                    {open && (
                      <>
                        ...
                        <PopoverPanel
                          ...
                          className="absolute inset-x-0 top-0 z-0 origin-top rounded-b-2xl bg-gray-50 px-4 sm:px-6 pt-24 sm:pt-32 pb-4 sm:pb-6 shadow-2xl shadow-gray-900/20"
                        >
                          <div className="space-y-4">
                            ...
                            <MobileNavLink href="/#pricing-section">
                              Preise
                            </MobileNavLink>
                            <MobileNavLink href="/#faqs">FAQs</MobileNavLink>
                            <MobileNavLink href="/#contact-section">Kontakt</MobileNavLink>
                          </div>
