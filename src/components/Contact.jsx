...
export default function Contact() {
    ...
    async function handleSubmit(event) {
        ...
        const res = await {success: true}; // submitContactForm(formData);
        if (res?.success === true) setStatus("success");
              ...
              />
                ...
                <div className="mt-10">
                    <button
                        ...
                        className={
                            (status === 'idle' ? "bg-indigo-600 hover:bg-indigo-500 focus-visible:outline-indigo-600 ": "") +
                            (status === 'submitting' ? "bg-gray-600 hover:bg-gray-500 focus-visible:outline-gray-600 ": "") +
                            (status === 'success' ? "bg-green-600 hover:bg-green-500 focus-visible:outline-green-600 ": "") +
                            (status === 'error' ? "bg-red-600 hover:bg-red-500 focus-visible:outline-red-600 ": "") +
                            (status === 'idle' ? "cursor-pointer ": "cursor-not-allowed ") +
                            `block w-full rounded-md px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-xs focus-visible:outline-2 focus-visible:outline-offset-2`}
                    >
